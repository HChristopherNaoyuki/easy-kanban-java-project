...
public class EasyKanban {
    ...
    private static boolean login() {
        ...
        String username = JOptionPane.showInputDialog("Enter username: (The Username: admin)");
        String password = JOptionPane.showInputDialog("Enter password: (The Passsword: password)");
    ...
    private static void addTasks() {
        ...
        for (int i = 0; i < numTasks; i++) {
            ...
            if (taskDescription.length() > 50) {
                ...
                i--; // Prompt user to re-enter this task
                continue;
            }
